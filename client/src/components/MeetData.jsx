                          ...
                          <div className="modal-dialog modal-dialog-centered" style={{ width: "30vw" }}>
                            <div className="modal-content">
                              ...
                              <div className="modal-footer">
                                ...
                                <button type="button" className="btn btn-primary" onClick={() => { socket.emit("update-meet-details", { roomId: meet._id, roomName: editRoomName, newMeetDate: editMeetDate, newMeetTime: editMeetTime }) }} data-bs-dismiss="modal">Update</button>
                              </div>
                            </div>
                          </div>
                        </div>
